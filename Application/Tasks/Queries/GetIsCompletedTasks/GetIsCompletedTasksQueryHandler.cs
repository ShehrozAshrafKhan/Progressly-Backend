...
{
    public class GetIsCompletedTasksQueryHandler : IRequestHandler<GetIsCompletedTasksQuery, Response<List<TaskDTO>>>
    {
        private readonly IApplicationDbContext _context;

        public GetIsCompletedTasksQueryHandler(IApplicationDbContext context)
        {
            _context = context;
        }
        public async Task<Response<List<TaskDTO>>> Handle(GetIsCompletedTasksQuery query, CancellationToken cancellationToken)
        {
            try
            {
                ...
                .Include(t => t.Assignees)
                    ...
                    .Where(x=>x.IsCompletedRequest==true&&x.IsActive==true)
